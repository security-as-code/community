...
1. Sponsored by 2 [Approver](#approver). Note the following requirements for sponsors:
    ...
    - Sponsors must be in an approvers or maintainers team for at least one resource.
      - Sponsors must be from multiple member companies to demonstrate integration across community.
1. [Open an issue](https://github.com/security-as-code/community/issues/new)

     - Ensure your sponsors are `@mentioned` on the issue
     - Complete every item on the checklist ([preview the current version of the
       template](https://github.com/security-as-code/community/issues/new?labels=membership&template=membership.md))
