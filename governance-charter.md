...
process for governance**. In addition to defining the initial
...
The project conducts [regular project meetings](https://github.com/security-as-code/community#meetings-and-events)
...
DATE his role will be assigned by project maintainers to **number** individuals listed in [Interested Parties](./interested-parties.md).
Each company/organization should have less than 50% of the seats,


### Establishment of a Governance Committee

To bootstrap the process of governance, NUMBER individuals were
...
Committee. Ultimately, the **Project Governance Committee will consist
...
In DATE we will hold the first election with 4 positions to be elected from the
...
One year later there will be an election to fill the four seats
opening up, each with a two year term.

One year after that, there will be an election to fill the 3 open
...
- For inquiries, please reach out to:
  - members of the [Governance Board](https://github.com/security-as-code/community/blob/main/community-members.md#governance-board)
